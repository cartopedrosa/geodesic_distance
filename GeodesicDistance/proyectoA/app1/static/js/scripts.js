$(function(){
    ...
    function displayLocation(position) {
        try {
            ...
            console.log("displayLocation, latitude1='"+cords.latitude+"'; longitude1='"+cords.longitude+"'");

            latitude1 = cords.latitude
            longitude1 = cords.longitude

            createMap(latitude1,longitude1)
        }
        catch(error){
                console.log(error);
        }
    ...
    function getMarkerCoords(marker){
        ...
        $('#latitude1').val(markerCoords.lat());
        $('#longitude1').val(markerCoords.lng());
        console.log(markerCoords.lat() + '  ' + markerCoords.lng())
    }


        function getMarkerCoords1(marker){
        var markerCoords = marker.getPosition();
        $('#latitude2').val(markerCoords.lat());
        $('#longitude2').val(markerCoords.lng());
        console.log(markerCoords.lat() + '  ' + markerCoords.lng())
    }
    ...
    $('#form_coords').submit(function(e){
        ...
        $.post('/ponto_1/',$(this).serialize(),function(data){
            if(data.ok)
            {
